...
with mobile_container():
    ...
    try:
        ...
        if asset:
            st.success(f"Backtesting for: {coin_choices[asset]}")
            with st.spinner("Fetching price history..."):
                try:
                    ...
                    if hist is not None and not hist.empty:
                        ...
                        st.info("Please check the asset name or try again later. Data may be unavailable due to API limits.")
                except Exception as e:
                    st.error(f"Error fetching price history: {e}")
                    st.info("Please check your internet connection or try again later. Data may be unavailable due to API limits.")
        else:
        ...
        st.error(f"Error in backtesting module: {e}")
